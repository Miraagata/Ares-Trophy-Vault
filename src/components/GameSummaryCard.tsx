...
export const GameSummaryCard: React.FC<GameSummaryCardProps> = ({ gameInfo, healthScore }) => {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-3 shadow-xl text-zinc-100 mb-3">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 items-center">
        ...
        <div className="lg:col-span-5 flex items-start gap-3">
          <div className="relative group shrink-0">
            {gameInfo.iconDataUrl || gameInfo.hasIcon ? (
              <img
                ...
                alt={gameInfo.title}
                className="w-20 h-20 rounded-xl object-cover border-2 border-zinc-700 shadow-md grayscale hover:grayscale-0 transition-all"
              />
            ) : (
              <div className="w-20 h-20 rounded-xl bg-zinc-950 border-2 border-zinc-700 flex items-center justify-center text-zinc-100 font-black text-2xl shadow-md">
                PS3
              </div>
            )}
            <span className="absolute -bottom-2 -right-2 bg-zinc-950 text-zinc-300 border border-zinc-700 text-[10px] font-mono px-1.5 py-0.5 rounded shadow">
              PS3
            </span>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs font-mono text-zinc-400">
              <span className="bg-zinc-950 px-2 py-0.5 rounded border border-zinc-800 text-zinc-200">
                {gameInfo.titleId}
              </span>
            ...
            <div className="pt-2 flex items-center gap-2">
              <span className="text-xs text-zinc-400">{t("sequenceHealth")}:</span>
              <div
        ...
        <div className="lg:col-span-3 flex flex-col justify-center border-t lg:border-t-0 lg:border-l border-zinc-800 pt-4 lg:pt-0 lg:pl-6">
          <div className="flex justify-between items-center text-xs text-zinc-400 mb-1.5 font-medium">
            <span>{t("completionProgress")}</span>
            <span className="text-white font-bold text-sm font-mono">{gameInfo.completionPercentage}%</span>
          </div>

          {/* Progress Bar */}
          <div className="w-full bg-zinc-950 rounded-full h-3.5 overflow-hidden border border-zinc-800 p-0.5">
            <div
        ...
        <div className="lg:col-span-4 flex flex-wrap items-center justify-start lg:justify-end gap-2 border-t lg:border-t-0 lg:border-l border-zinc-800 pt-4 lg:pt-0 lg:pl-6">
          ...
          <div className="flex items-center gap-2 bg-zinc-950 border border-zinc-800 px-3 py-1.5 rounded-xl text-xs">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] text-zinc-400 uppercase font-semibold">{t("platinum")}</span>
          ...
          <div className="flex items-center gap-2 bg-zinc-950 border border-zinc-800 px-3 py-1.5 rounded-xl text-xs">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] text-zinc-400 uppercase font-semibold">{t("gold")}</span>
          ...
          <div className="flex items-center gap-2 bg-zinc-950 border border-zinc-800 px-3 py-1.5 rounded-xl text-xs">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] text-zinc-400 uppercase font-semibold">{t("silver")}</span>
          ...
          <div className="flex items-center gap-2 bg-zinc-950 border border-zinc-800 px-3 py-1.5 rounded-xl text-xs">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] text-zinc-400 uppercase font-semibold">{t("bronze")}</span>
